...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `luxcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ luxcore-node add wallet-service');
      console.log('    $ luxcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ luxcore-node remove wallet-service');
      console.log('    $ luxcore-node remove insight-api');
      console.log();
    });
