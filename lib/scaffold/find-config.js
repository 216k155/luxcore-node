...
/**
 * Will return the path and luxcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'luxcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'luxcore-node.json'))
  };
}
