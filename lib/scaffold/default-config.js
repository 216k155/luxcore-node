...
/**
 * Will return the path and default luxcore-node configuration. It will search for the
 * configuration file in the "~/.luxcoin" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.luxcoin');
  var defaultConfigFile = path.resolve(defaultPath, './luxcore-node.json');
