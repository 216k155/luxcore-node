...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    luxd.spawn.datadir.should.equal(home + '/.lux');
    luxd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/luxd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.luxd.spawn.datadir.should.equal('./data2');
  });
});
